...
# based on https://github.com/ansible/ansible/blob/devel/lib/ansible/plugins/callback/default.py
...
#---------------------------------------#
# Begin custom progress display imports #
import sys
import threading
import time
...
class CallbackModule(CallbackBase):
    ...
    CALLBACK_NAME = 'progress_default'
    ...
    def v2_runner_retry(self, result):
        ...
        msg = "RETRYING: %s (%d retries left)." % (task_name, result._result['retries'] - result._result['attempts'])
        ...
        self.progress_display(msg, color=C.COLOR_DEBUG, end_line=False)
